...
\noindent\textbf{Ian Liu} led the integration and productization work: adapting Animated Drawings to custom MediaPipe/BVH motion, building the offline video-to-motion path and the live/web interfaces, adding upload and diagnostic support, validating rendering behavior, and polishing the final report. 


\textbf{Chen-En Ma} led the pose-repair and learned-model exploration: developing and evaluating the landmark-flow corrector, integrating the learned repair experiment into the interface, contributing custom character and report assets, and helping validate the final references and presentation materials.
