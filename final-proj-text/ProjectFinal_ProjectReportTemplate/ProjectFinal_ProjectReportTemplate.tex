...
\author{
    \emph{Team name}: Ian Liu, Chen-En Ma\\
...
%%%%%%%%% ABSTRACT
\begin{abstract}
This document is a template for your final project reports, presented in a conference-paper style. It is slightly more complicated LaTeX, but not much more complex than the earlier project reports.
...
\begin{enumerate}
    ...
    \item If you wish us to consider any aspect of your project, it should be presented here.
    \item Please include a problem statement, related work, your method, your results (figures! tables!), any comparison to existing techniques, and references.
    ...
    \item Length: Approximately four pages for technical description. For social impact, no more than one page total.
